...
def serve(
    ...
    async def serve_inner(
        ...
        logger.info("server inner at rank %s for world size %s" % (os.environ["RANK"], os.environ["WORLD_SIZE"]))
        try:
            model = get_model(
    ...
    logger.info("server at rank %s for world size %s" % (os.environ["RANK"], os.environ["WORLD_SIZE"]))
    asyncio.run(
