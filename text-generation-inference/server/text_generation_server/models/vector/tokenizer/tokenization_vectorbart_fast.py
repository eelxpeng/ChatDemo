...
PRETRAINED_VOCAB_FILES_MAP = {
    ...
    "tokenizer_file": {
        "vectorbert-large": "./tokenizer.json",
    },
}
...
class DoNotUseVectorBartTokenizerFast(PreTrainedTokenizerFast):
    """
    ...
    slow_tokenizer_class = VectorBartTokenizer
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.add_special_tokens(
            {"additional_special_tokens": FAIRSEQ_LANGUAGE_CODES + USER_DEFINED_SYMBOLS}
        )
        ...
        self._tgt_lang = tgt_lang if tgt_lang is not None else "<en_XX>"
        self.cur_lang_code_id = self.lang_code_to_id[self._src_lang]
        self.tgt_lang_code_id = self.lang_code_to_id.get(self._src_lang)
        self.set_src_lang_special_tokens(self._src_lang, self._src_lang)
    ...
    def src_lang(self, new_src_lang: str) -> None:
        ...
        self.set_src_lang_special_tokens(self._src_lang, self._tgt_lang)
    ...
    def as_target_tokenizer(self):
        ...
        """
        logger.info(f"setting tgt_lang to {self.tgt_lang}")
        self.set_tgt_lang_special_tokens(self.tgt_lang)
        yield
        logger.info(f"setting src_lang to {self.src_lang}, tgt_lang to {self.tgt_lang}")
        self.set_src_lang_special_tokens(self.src_lang, self.tgt_lang)
    ...
    def set_src_lang_special_tokens(self, src_lang: str, tgt_lang: str) -> None:
        ...
        if self.convert_tokens_to_ids(tgt_lang) == 3:
            logger.warn(
                f"tgt_lang {tgt_lang} is not in token map {self.convert_tokens_to_ids}. Setting it to {src_lang}."
            )
            tgt_lang = src_lang
        self.tgt_lang_code_id = self.convert_tokens_to_ids(tgt_lang)
        self.prefix_tokens = [self.cur_lang_code_id]
        # this makes sure that the model knows what it needs to generate at encoding time
        self.suffix_tokens = []  # [self.eos_token_id, self.tgt_lang_code_id]
    ...
    def set_tgt_lang_special_tokens(self, tgt_lang: str) -> None:
        ...
        self.prefix_tokens = []  # [self.tgt_lang_code_id]
