...
export default function Home() {
  ...
  const handleSend = async (message: Message) => {
    if (selectedConversation) {
      ...
      console.log("finish fetching response from /api/chat");
      ...
      try {
        while (!done) {
          ...
          if (decodedValue.endsWith("</s>")) {
            done = true
            console.log("Done reading ReadableStream");
          }
          const chunkValue = decodedValue.endsWith("</s>") ? decodedValue.slice(0, -4) : decodedValue
